...
public class ActionCardCtl : MonoBehaviour {
    ...
    void Start () {
        ...
        if (this.down_option != type_opt.nil) {
            this.face.transform.Find ("uptype").gameObject.GetComponent<RawImage> ().texture =
                Resources.Load<Texture2D> ("ActionCard/Image/" + up_option.ToString ()) as Texture2D;
            this.face.transform.Find ("dwtype").gameObject.GetComponent<RawImage> ().texture =
                Resources.Load<Texture2D> ("ActionCard/Image/" + down_option.ToString ()) as Texture2D;
            this.face.transform.Find ("upval").gameObject.GetComponent<Text> ().text = (this.up_val).ToString ();
            this.face.transform.Find ("dwval").gameObject.GetComponent<Text> ().text = (this.down_val).ToString ();
        } else {
            this.face.transform.Find ("uptype").gameObject.GetComponent<RawImage> ().texture =
                Resources.Load<Texture2D> ("ActionCard/Image/sp/" + up_option.ToString ()) as Texture2D;
            this.face.transform.Find ("uptype").gameObject.GetComponent<RectTransform> ().sizeDelta = new Vector2 (61f, 100f);
            this.face.transform.Find ("dwtype").gameObject.GetComponent<RawImage> ().color =
                new Color (0f, 0f, 0f, 0f);
            this.face.transform.Find ("upval").gameObject.GetComponent<Text> ().text = (this.up_val).ToString ();
            this.face.transform.Find ("dwval").gameObject.GetComponent<Text> ().text = "";
        }
