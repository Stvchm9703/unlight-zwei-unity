...
public class CCardCtl : MonoBehaviour {
    ...
    public IEnumerator InitCCImg(AssetBundle ab, CardObject Co, CardSetPack Cs) {
    ...
    public IEnumerator InitCCImg2(Texture2D CharImg, CardObject Co, CardSetPack Cs) {
        // Debug.Log($"ab:{ab == null},Co:{Co == null},Cs:{Cs == null}");
        this.original = Cs;
