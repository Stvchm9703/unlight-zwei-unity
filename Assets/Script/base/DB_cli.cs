...
namespace UnlightCli {
    ...
    public static class DuelSocket {
        public static Socket ConnectSocket(){

        }
        
        public static Socket OpenSocket(CfServerSetting cfserver){
...
public static void StartServer() {
    ...
    try { // Create a Socket that will use Tcp protocol
...
public static void StartClient() {
    ...
    try {
        ...
        try { // Connect to Remote EndPoint
